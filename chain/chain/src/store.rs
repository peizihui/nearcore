...
impl ChainStoreAccess for ChainStore {
    ...
    fn largest_endorsed_height(&self) -> Result<BlockHeight, Error> {
        option_to_not_found(
            self.store.get_ser(ColBlockMisc, LARGEST_ENDORSED_HEIGHT_KEY),
            "LARGEST_ENDORSED_HEIGHT_KEY",
        )
    }
    ...
    fn largest_skipped_height(&self) -> Result<BlockHeight, Error> {
        option_to_not_found(
            self.store.get_ser(ColBlockMisc, LARGEST_SKIPPED_HEIGHT_KEY),
            "LARGEST_SKIPPED_HEIGHT_KEY",
        )
    }
